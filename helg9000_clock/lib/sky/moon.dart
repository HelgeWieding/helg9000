...
class Moon extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    var rect = Rect.fromCircle(center: Offset(center.dx, center.dy), radius: this._radius);

    Path path = Path();
    path.arcTo(rect, pi / 2, pi, false);
    path.cubicTo(center.dx - 18, center.dy - 10, center.dx - 18, center.dy + 12, center.dx, center.dy + this._radius);
    path.close();
